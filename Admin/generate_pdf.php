...
<body>
    ...
    <!--         <h3>Daily Sales</h3> -->
    <!--         <div class="amount">₱ <?php echo number_format($dailySales, 2); ?></div> -->
    <!--         <div class="date"><?php echo date('F j, Y', strtotime($dailyDate)); ?></div> -->
    <!--     </div> -->
    <!--      -->
    <!--     <div class="summary-box"> -->
    <!--         <h3>Weekly Sales</h3> -->
    <!--         <div class="amount">₱ <?php echo number_format($weeklySales, 2); ?></div> -->
    <!--         <div class="date"><?php echo date('F j, Y', strtotime($weeklyStartDate)) . ' - ' . date('F j, Y', strtotime($weeklyEndDate)); ?></div> -->
    <!--     </div> -->
    <!--      -->
    <!--     <div class="summary-box"> -->
    <!--         <h3>Monthly Sales</h3> -->
    <!--         <div class="amount">₱ <?php echo number_format($monthlySales, 2); ?></div> -->
    <!--         <div class="date"><?php echo date('F j, Y', strtotime($monthlyStartDate)) . ' - ' . date('F j, Y', strtotime($monthlyEndDate)); ?></div> -->
    <!--     </div> -->
    <!-- </div> -->
